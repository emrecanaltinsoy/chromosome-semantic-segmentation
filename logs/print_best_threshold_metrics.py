...
others = {'adaptive_thresholding': 'Adaptive Thresholding', 
        'histogram_analysis': 'Histogram Analysis', 
        }
    
others2 = {'proposed_cnn_bcn': 'Proposed CNN + BCN', }
...
print('\n')
print('{:<25}  {:<10}  {:<10}  {:<10}  {:<10}  {:<10}'.format('Model', 'Dice (%)', 'Se (%)', 'Sp (%)', 'Pre (%)', 'Acc (%)')) #'Ch1 DSC',
...
for _, other in enumerate(others):
    ...
    print('{:<25}  {:<10}  {:<10}  {:<10}  {:<10}  {:<10}'.format(m, dsc, se, sp, pre, acc))
