...
def feature_extraction(label1_dir, label2_dir):
    ...
    connectivity = 8  
    num_labels, labels, stats, _ = cv2.connectedComponentsWithStats(I_bin, connectivity, cv2.CV_32S)
    ...
    all_data = np.stack([areas_npy,conv_hull_area_npy,average_label1_pixel_npy,average_label2_pixel_npy],axis=1)
